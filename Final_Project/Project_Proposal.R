...
```{r}
library(png)
img <- readPNG("C:/Users/17166/OneDrive - University at Buffalo/Desktop/Fall Semester 2022/GEO 511/case_studies-Hughes-Eric/Final_Project/Example_1.png")
grid::grid.raster(img)

```

This graphic does a good job at making the spatial relationship very apparent. This was created using dodgr and I think I could make a similar graphic specific to my project subject.
...
I like how the background is grey scale and the important data is colorized in easily differential color assignments. It's very simple but clean. I believe this could be achieved via ggplot() with use of the RColorBrewer package. 
...
I expect to generate choropleth maps for the income brackets that show which brackets have the shortest distances to supermarkets via the different modes of transportation. I will also create several accompanying bar graphs of demographic data per income bracket. Tables will also be provided that show a breakdown of the data generated from my results. 
